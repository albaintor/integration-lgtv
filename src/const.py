...
# Note: Dynamic app launch commands (LAUNCH_*) are added at runtime based on
    ...
    UiPage(
        **{
            ...
            "items": [
                ...
                {
                    "command": {"cmd_id": "INPUT_SOURCE"},
                    "text": "Input",
                    "location": {"x": 2, "y": 1},
                    "type": "text",
                },
                {
                    "command": {"cmd_id": "3D_MODE"},
                    "text": "3D",
                    "location": {"x": 3, "y": 1},
                    "type": "text",
                },
                ...
                {
                    "command": {"cmd_id": "CHANNELUP"},
                    "icon": "uc:up-arrow",
                    "location": {"x": 3, "y": 3},
                    "type": "icon",
                },
                {
                    "command": {"cmd_id": "CHANNELDOWN"},
                    "icon": "uc:down-arrow",
                    "location": {"x": 3, "y": 4},
                    "type": "icon",
                },
                {
                    "command": {"cmd_id": "ASPECT_RATIO"},
                ...
                {
                    "command": {"cmd_id": "VOLUMEDOWN"},
                    "icon": "uc:minus",
                    "location": {"x": 1, "y": 5},
                    "type": "icon",
                },
                {
                    "command": {"cmd_id": "VOLUMEUP"},
                    "icon": "uc:plus",
                    "location": {"x": 2, "y": 5},
                    "type": "icon",
                },
